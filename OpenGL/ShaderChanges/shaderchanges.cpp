...
/*
   ...
   A uniform value in GLSL is then used to update the colour of the bottom
...
int main(int argc, char *argv[]) {
    ...
    glShaderSource(fragmentShaderUniform, 1, &fragmentShaderSourceUniform,
                   NULL);
    ...
    unsigned int shaderProgramOrange, shaderProgramUniform;
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Set uniform value to change colour of triangle
        float timeValue = glfwGetTime();
        float greenValue = (sin(timeValue) / 2.0f) + 0.5f;
        int vertexColorLocation =
            glGetUniformLocation(shaderProgramUniform, "ourColor");
